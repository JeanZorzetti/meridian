...
// Upsert keyed by (card_id, month) — the same natural-key POST rollover.ts
// uses. An invoice is identified by which card and which month, never an id
// the client needs to remember; "set the extrato total" and "mark it paid"
// are the same write.

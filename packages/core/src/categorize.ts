...
// user has actually confirmed — see `category_source` in db/migrations/0001_baseline.sql.
...
export interface Guess {
  category: string;
  /** Mirrors `category_source` in db/migrations/0001_baseline.sql — only 'user' trains the model.
